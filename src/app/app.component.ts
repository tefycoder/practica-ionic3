...
export class MyApp {
  ...
  state: any;
  placeholder = 'assets/img/logo/logoprincipal.png';
  chosenPicture: any;
  ...
  initializeApp() {
    this.platform.ready().then(() => {
      ...
      // Bien, entonces la plataforma está lista y nuestros complementos están disponibles.
  ...
  openPage(page) {
   // Restablecer el contenido de navegación para tener solo esta página
    // no quisiéramos que el botón Atrás se muestre en este escenario
